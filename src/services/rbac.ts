...
export const updateAdminRBAC = async (id: number, payload: UpdateRBACPayload): Promise<AdminRBACProfile> => {
  try {
    const response = await api.patch(`/manager/rbac/${id}/update_permissions/`, payload);
